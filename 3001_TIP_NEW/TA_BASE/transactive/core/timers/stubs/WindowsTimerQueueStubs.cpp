...
/** User stub definition for function: MMRESULT timeSetEvent(UINT, UINT, LPTIMECALLBACK, DWORD_PTR, UINT) */
extern "C" ::MMRESULT __stdcall timeSetEvent (::UINT uDelay, ::UINT uResolution, ::LPTIMECALLBACK fptc, ::DWORD_PTR dwUser, ::UINT fuEvent) ;
extern "C" ::MMRESULT __stdcall CppTest_Stub_timeSetEvent (::UINT uDelay, ::UINT uResolution, ::LPTIMECALLBACK fptc, ::DWORD_PTR dwUser, ::UINT fuEvent) 
{
	if(0 == debugFlag)
		return 0U;
    return 1U;
